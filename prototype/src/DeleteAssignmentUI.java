...
public class DeleteAssignmentUI extends JDialog {

	public DeleteAssignmentUI() {
        initUI();
	}
    ...
    private final void initUI() {
        ...
        message2Panel.add(new JLabel(
        		"and all its submitted scores?"
        	));

        message2Panel.add(Box.createRigidArea(new Dimension(25, 0)));
    ...
    public static void showDeleteAssignmentUI {  
        DeleteAssignmentUI catFrame = new DeleteAssignmentUI();
