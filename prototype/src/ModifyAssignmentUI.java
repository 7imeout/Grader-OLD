...
public class ModifyAssignmentUI extends JDialog {

	public ModifyAssignmentUI() {
        initUI();
	}
    ...
    private final void initUI() {
        ...
        JButton addCatButton = new JButton("Modify Assignment");
    ...
    public static void showModifyAssignmentUI() {
        ModifyAssignmentUI asgnFrame = new ModifyAssignmentUI();
        asgnFrame.setVisible(true);
    }
}