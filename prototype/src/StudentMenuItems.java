...
public class StudentMenuItems implements MenuItemProvider {
   ...
   private ArrayList<JMenuItem> studentContextMenuItems;

   public StudentMenuItems() {
      studentMenuItems = new ArrayList<JMenuItem>();
      studentContextMenuItems = new ArrayList<JMenuItem>();
   ...
   private void createMenuItems() {
      ...
      studentContextMenuItems.add(addDeleteStudentMenu());
   }
   ...
   public ArrayList<JMenuItem> getContextMenuItems() {
      return studentContextMenuItems;
   }
}